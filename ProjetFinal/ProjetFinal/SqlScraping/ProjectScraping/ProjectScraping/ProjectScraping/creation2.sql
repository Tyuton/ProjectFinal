...
CREATE TABLE [dbo].[ResultsHeader](
	[ResultHeaderId] [uniqueidentifier] NOT NULL,
	--[QuieryId] [uniqueidentifier] NOT NULL,
	[SelectorId] [uniqueidentifier] NOT NULL,
...
ALTER TABLE [dbo].[ResultsHeader]  WITH CHECK ADD  CONSTRAINT [FK_Results_Selector] FOREIGN KEY([SelectorId])
REFERENCES [dbo].[Selector] ([SelectorId])
GO

ALTER TABLE [dbo].[ResultsHeader] CHECK CONSTRAINT [FK_Results_Selector]
GO
